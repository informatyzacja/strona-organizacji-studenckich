...
export interface paths {
  ...
  "/items/Tagi": {
    /**
     * List Items
     * @description List the Tagi items.
     */
    get: operations["readItemsTagi"];
    /**
     * Create an Item
     * @description Create a new Tagi item.
     */
    post: operations["createItemsTagi"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing Tagi items.
     */
    delete: operations["deleteItemsTagi"];
    /**
     * Update Multiple Items
     * @description Update multiple Tagi items at the same time.
     */
    patch: operations["updateItemsTagi"];
  };
  "/items/Tagi/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single Tagi item by unique identifier.
     */
    get: operations["readSingleItemsTagi"];
    /**
     * Delete an Item
     * @description Delete an existing Tagi item.
     */
    delete: operations["deleteSingleItemsTagi"];
    /**
     * Update an Item
     * @description Update an existing Tagi item.
     */
    patch: operations["updateSingleItemsTagi"];
  };
  "/items/Organizacje_Tagi": {
    /**
     * List Items
     * @description List the Organizacje_Tagi items.
     */
    get: operations["readItemsOrganizacjeTagi"];
    /**
     * Create an Item
     * @description Create a new Organizacje_Tagi item.
     */
    post: operations["createItemsOrganizacjeTagi"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing Organizacje_Tagi items.
     */
    delete: operations["deleteItemsOrganizacjeTagi"];
    /**
     * Update Multiple Items
     * @description Update multiple Organizacje_Tagi items at the same time.
     */
    patch: operations["updateItemsOrganizacjeTagi"];
  };
  "/items/Organizacje_Tagi/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single Organizacje_Tagi item by unique identifier.
     */
    get: operations["readSingleItemsOrganizacjeTagi"];
    /**
     * Delete an Item
     * @description Delete an existing Organizacje_Tagi item.
     */
    delete: operations["deleteSingleItemsOrganizacjeTagi"];
    /**
     * Update an Item
     * @description Update an existing Organizacje_Tagi item.
     */
    patch: operations["updateSingleItemsOrganizacjeTagi"];
  };
  "/items/Organizacje_files": {
    /**
     * List Items
     * @description List the Organizacje_files items.
     */
    get: operations["readItemsOrganizacjeFiles"];
    /**
     * Create an Item
     * @description Create a new Organizacje_files item.
     */
    post: operations["createItemsOrganizacjeFiles"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing Organizacje_files items.
     */
    delete: operations["deleteItemsOrganizacjeFiles"];
    /**
     * Update Multiple Items
     * @description Update multiple Organizacje_files items at the same time.
     */
    patch: operations["updateItemsOrganizacjeFiles"];
  };
  "/items/Organizacje_files/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single Organizacje_files item by unique identifier.
     */
    get: operations["readSingleItemsOrganizacjeFiles"];
    /**
     * Delete an Item
     * @description Delete an existing Organizacje_files item.
     */
    delete: operations["deleteSingleItemsOrganizacjeFiles"];
    /**
     * Update an Item
     * @description Update an existing Organizacje_files item.
     */
    patch: operations["updateSingleItemsOrganizacjeFiles"];
  };
  "/items/Organizacje": {
    /**
     * List Items
     * @description List the Organizacje items.
     */
    get: operations["readItemsOrganizacje"];
    /**
     * Create an Item
     * @description Create a new Organizacje item.
     */
    post: operations["createItemsOrganizacje"];
    /**
     * Delete Multiple Items
     * @description Delete multiple existing Organizacje items.
     */
    delete: operations["deleteItemsOrganizacje"];
    /**
     * Update Multiple Items
     * @description Update multiple Organizacje items at the same time.
     */
    patch: operations["updateItemsOrganizacje"];
  };
  "/items/Organizacje/{id}": {
    /**
     * Retrieve an Item
     * @description Retrieve a single Organizacje item by unique identifier.
     */
    get: operations["readSingleItemsOrganizacje"];
    /**
     * Delete an Item
     * @description Delete an existing Organizacje item.
     */
    delete: operations["deleteSingleItemsOrganizacje"];
    /**
     * Update an Item
     * @description Update an existing Organizacje item.
     */
    patch: operations["updateSingleItemsOrganizacje"];
  };
}
...
export interface components {
  schemas: {
    ...
    ItemsOrganizacjeTagi: {
      id?: number;
      Organizacje_id?:
        | string
        | components["schemas"]["ItemsOrganizacje"]
        | null;
      Tagi_id?: number | components["schemas"]["ItemsTagi"] | null;
    };
    ItemsOrganizacjeFiles: {
      id?: number;
      Organizacje_id?:
        | string
        | components["schemas"]["ItemsOrganizacje"]
    ...
    ItemsOrganizacje: {
      ...
      skillsAndChallenges?: string | null;
      ...
      images?:
        | (number | components["schemas"]["ItemsOrganizacjeFiles"])[]
        | null;
      tags?: (number | components["schemas"]["ItemsOrganizacjeTagi"])[] | null;
    };
  };
  responses: {
...
export interface operations {
  ...
  readItemsTagi: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsTagi"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  updateSingleItemsTagi: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsTagi"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  readItemsOrganizacjeTagi: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsOrganizacjeTagi"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsOrganizacjeTagi: {
    ...
    requestBody?: {
      content: {
        "application/json":
          | components["schemas"]["ItemsOrganizacjeTagi"][]
          | components["schemas"]["ItemsOrganizacjeTagi"];
      };
    };
    responses: {
   ...
   * @description Retrieve a single Organizacje_Tagi item by unique identifier.
   */
  readSingleItemsOrganizacjeTagi: {
    parameters: {
      query?: {
        fields?: components["parameters"]["Fields"];
        meta?: components["parameters"]["Meta"];
   ...
   * @description Delete an existing Organizacje_Tagi item.
   */
  deleteSingleItemsOrganizacjeTagi: {
    parameters: {
      path: {
        /** @description Index of the item. */
        id: number | string;
   ...
   * @description Update an existing Organizacje_Tagi item.
   */
  updateSingleItemsOrganizacjeTagi: {
    parameters: {
      query?: {
        fields?: components["parameters"]["Fields"];
        meta?: components["parameters"]["Meta"];
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsOrganizacjeTagi"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  readItemsOrganizacjeFiles: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsOrganizacjeFiles"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsOrganizacjeFiles: {
    ...
    requestBody?: {
      content: {
        "application/json":
          | components["schemas"]["ItemsOrganizacjeFiles"][]
          | components["schemas"]["ItemsOrganizacjeFiles"];
      };
    };
    responses: {
   ...
   * @description Retrieve a single Organizacje_files item by unique identifier.
   */
  readSingleItemsOrganizacjeFiles: {
    parameters: {
      query?: {
        fields?: components["parameters"]["Fields"];
        meta?: components["parameters"]["Meta"];
   ...
   * @description Delete an existing Organizacje_files item.
   */
  deleteSingleItemsOrganizacjeFiles: {
    parameters: {
      path: {
        /** @description Index of the item. */
        id: number | string;
   ...
   * @description Update an existing Organizacje_files item.
   */
  updateSingleItemsOrganizacjeFiles: {
    parameters: {
      query?: {
        fields?: components["parameters"]["Fields"];
        meta?: components["parameters"]["Meta"];
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsOrganizacjeFiles"];
      };
    };
    responses: {
      /** @description Successful request */
  ...
  readItemsOrganizacje: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsOrganizacje"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  updateSingleItemsOrganizacje: {
    ...
    requestBody?: {
      content: {
        "application/json": components["schemas"]["ItemsOrganizacje"];
      };
    };
    responses: {
      /** @description Successful request */
...
export type ApiCollections = {
  Tagi: components["schemas"]["ItemsTagi"][];
  Organizacje_Tagi: components["schemas"]["ItemsOrganizacjeTagi"][];
  Organizacje_files: components["schemas"]["ItemsOrganizacjeFiles"][];
  Organizacje: components["schemas"]["ItemsOrganizacje"][];
};
